...
HX711MULTI::HX711MULTI(int count, byte *dout, byte pd_sck, byte gain, byte PIN_RELAIS) {
	PD_SCK 	= pd_sck;
...
void HX711MULTI::printOk(byte gain) {
...
void HX711MULTI::set_dout(int count, byte *dout) {
...
bool HX711MULTI::wait_ready_timeout(unsigned long timeout, unsigned long delay_ms) {
